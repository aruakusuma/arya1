...
/////////////////
const BotName = 'ARYA BOT☄'; 
const instagram = 'https://instagram.com/aryakk3003'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@aryakk3003')
